...
const by: ILangObject = {
    ...
    'subtitle': 'на пляцоўку/IDE для запытаў graphQL',
...
export const getTranslation = (
    ...
    const currTranslation = translations[locale as keyof typeof translations] ? translations[locale as keyof typeof translations] : en;
    let translated = currTranslation[key] ? currTranslation[key] : en[key] ? en[key] : key;
